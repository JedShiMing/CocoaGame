...
var fastHash = {
    ...
    fasthash64: function (buff) {
        ...
        if((index<8)&&(index>0))
        {
            ...
            if(bb.offset<len){L1 = bb.readUint8();}
            if(bb.offset<len){L2 = bb.readUint8();}
            if(bb.offset<len){L3 = bb.readUint8();}
            if(bb.offset<len){L4 = bb.readUint8();}
            if(bb.offset<len){H1 = bb.readUint8();}
            if(bb.offset<len){H2 = bb.readUint8();}
            if(bb.offset<len){H3 = bb.readUint8();}
            if(bb.offset<len){H4 = bb.readUint8();}
