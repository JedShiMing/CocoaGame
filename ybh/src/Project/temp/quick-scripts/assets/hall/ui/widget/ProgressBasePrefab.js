(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/hall/ui/widget/ProgressBasePrefab.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '3db35eNWbxCUYPkKg1a//q/', 'ProgressBasePrefab', __filename);
// hall/ui/widget/ProgressBasePrefab.js
...
cc.Class({
    ...
    showGain: function showGain(gainInfo) {
        ...
        this.expNum.node.runAction(cc.sequence(cc.delayTime(1.0), cc.callFunc(function () {
            self.goldNode.active = false;
            self.crystalNode.active = false;
        })));
    },

    showExp: function showExp(listInfo) {
    ...
    showAction: function showAction(node, callBack) {
        node.active = true;
        node.scale = 0;

        var self = this;
        var act = cc.sequence(cc.callFunc(function (target) {
            self.step = 1;
        }), cc.spawn(cc.scaleTo(0.6, 1).easing(cc.easeBackOut()), cc.delayTime(0.6)), cc.delayTime(0.4), cc.callFunc(function (target) {
            self.step = 2;
            node.scale = 0;
            callBack && callBack();
        }));
    ...
    update: function update(dt) {
        ...
        if (this.durationTime < this.intervalTime) {
            return;
        }

        this.durationTime = 0;
        if (this.index >= this.listInfo.length) {
            return;
        }

        var percent = this.listInfo[this.index];
        if (1 === percent) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ProgressBasePrefab.js.map
