(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/hall/ui/scene/HallLoginScene.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ce460zL6ThEDIMWLSWy/URR', 'HallLoginScene', __filename);
// hall/ui/scene/HallLoginScene.js
...
cc.Class({
    ...
    _loadLocalVersionFile: function _loadLocalVersionFile() {
    ...
    _startLoadRemoteVersionFile: function _startLoadRemoteVersionFile() {
        if (this.step !== STEP.WAIT_REMOTE_VERSION) return;
        AF.Downloader.startDownloadFile(VERSION_FILE, true);
    },

    _loadAndCheckVersion: function _loadAndCheckVersion(filename, tempFilePath, state) {
        if (this.step !== STEP.WAIT_REMOTE_VERSION) return;
    ...
    _downloadFilelist: function _downloadFilelist(downloadState) {
    ...
    _saveRemoteVersionFile: function _saveRemoteVersionFile() {
        if (this.step !== STEP.WAIT_FILELIST_AND_VERSION) return;
    ...
    _loadConfigFileList: function _loadConfigFileList() {
        if (this.step !== STEP.WAIT_LOAD_CONFIG) return;
        this.configList = ["model", "player", "point"];

        this.index = 0;
        this._startLoadConfig();
    },

    _startLoadConfig: function _startLoadConfig() {
        if (this.step !== STEP.WAIT_LOAD_CONFIG) return;
    ...
    update: function update(dt) {
        ...
        if (STEP.LAUNCH_INIT === self.step) {
            ...
            if (self.tryTimes > 3) {
                ...
                AF.MessageBox.OK("启动失败", "点击确定重试！", function (ret) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=HallLoginScene.js.map
