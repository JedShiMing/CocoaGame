(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/framework/ui/mgr/af-scene-mgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b502d/ETWBI0ZFd9VjCz5XC', 'af-scene-mgr', __filename);
// framework/ui/mgr/af-scene-mgr.js
...
var SceneManager = (window.AF = window.AF || {}).SceneMgr = cc.Class({
    ...
    setEnableSwitchSceneAnim: function setEnableSwitchSceneAnim(state) {
    ...
    getCurSceneParams: function getCurSceneParams() {
        return this._sceneParams;
    },

    getCurDialogParams: function getCurDialogParams() {
    ...
    // 是否正在切换场景
    isSwitchingScene: function isSwitchingScene() {
        return this._switchingSceneFlags.switching;
    },

    switchScene: function switchScene(sceneName, params, onLoad) {
        ...
        if (this._enableSwitchSceneAnim) this._switchSceneAnimIn();
        var self = this;
        cc.director.preloadScene(sceneName, function () {
            ...
            if (!self._enableSwitchSceneAnim || flags.inAnimationDone) self._loadScene();
        });
    },

    _loadScene: function _loadScene() {
        var flags = this._switchingSceneFlags;
    ...
    sceneLoadedMsg: function sceneLoadedMsg() {
        ...
        if (this._enableSwitchSceneAnim) this._switchSceneAnimOut();
    },
    // 添加切换场景动画
    addSwitchSceneAinm: function addSwitchSceneAinm(name, prefabPath) {
        var self = this;
    ...
    // 场景切换动画B
    _switchSceneAnimOut: function _switchSceneAnimOut() {
        // console.log('结束动画')
        var anim = this._getSwitchAnimComponent();
        anim && anim.playOutAnim();
    },
    // 切换动画A
    _switchSceneAnimIn: function _switchSceneAnimIn() {
        // console.log('开始动画')
        var flags = this._switchingSceneFlags;
        var anim = this._getSwitchAnimComponent();
        if (anim) {
    ...
    _getSwitchAnimComponent: function _getSwitchAnimComponent(name) {
    ...
    // 直接挂在场景上，这样可以避免重复实例化
    registerDialog: function registerDialog(dialogName, node) {
        this._sceneDialog[dialogName] = node;
    },
    // 注意：dialog节点被销毁时必须unregister
    unregisterDialog: function unregisterDialog(dialogName) {
    ...
    _clearDialogCacheAndStack: function _clearDialogCacheAndStack() {
        this._dialogCache = {};
        this._dialogStack = [];
        this._tryToOpenDialog = undefined;
    },

    _loadDialog: function _loadDialog(dialogName, onLoad, active) {
    ...
    preloadDialog: function preloadDialog(dialogName, onLoad) {
    ...
    openDialog: function openDialog(dialogName, params, onOpened) {
    ...
    onDialogClosed: function onDialogClosed(dialogName, node) {
    ...
    getCurDialog: function getCurDialog() {
        var len = this._dialogStack.length;
        return len > 0 ? this._dialogStack[len - 1] : undefined;
    },
    _pushDialogToStack: function _pushDialogToStack(dialogName, node) {
        var len = this._dialogStack.length;
    ...
    _hasDialogInStack: function _hasDialogInStack(dialogName) {
        var len = this._dialogStack.length;
        for (var i = 0; i < len; ++i) {
            var v = this._dialogStack[i];
            if (v.name === dialogName) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=af-scene-mgr.js.map
